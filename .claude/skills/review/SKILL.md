...
name: review
description: >
  Review a sip2nostr PR, branch, or working diff. Use when asked to review
  changes, check a PR, assess a commit, or judge whether a follow-up commit
  addressed earlier review feedback.
---

# Reviewing sip2nostr changes

Repo facts - architecture invariants, build and test commands, config
validation style - live in `AGENTS.md` and are already loaded. This file is
about how to review, not what the codebase is.
